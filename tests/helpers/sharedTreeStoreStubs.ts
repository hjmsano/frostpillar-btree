...
export class SyncCountingStore<TKey, TValue> implements SharedTreeStore<
  TKey,
  TValue
> {
  public syncCount = 0;
...
export class AtomicMemorySharedTreeStore<
  TKey,
  TValue,
...
export class FailOnceCompareAndSetStore<
  TKey,
  TValue,
> implements SharedTreeStore<TKey, TValue> {
  private readonly delegate: AtomicMemorySharedTreeStore<TKey, TValue>;
...
export class DelayFirstReadStore<TKey, TValue> implements SharedTreeStore<
  TKey,
  TValue
> {
  private readonly delegate: AtomicMemorySharedTreeStore<TKey, TValue>;
...
export class DelayFirstSuccessfulAppendStore<
  TKey,
  TValue,
> implements SharedTreeStore<TKey, TValue> {
  private readonly delegate: AtomicMemorySharedTreeStore<TKey, TValue>;
...
export class JumpVersionStore<TKey, TValue> implements SharedTreeStore<
  TKey,
  TValue
> {
  private version = 0n;
